...
function backPage() {
    window.location.href = "eitk-1.html";
}

let cong = document.getElementById("congrates");
let boot = document.getElementById("boost");
...
function nextPage() {
    if (score >= 15) {
        ...
        alert("Your score is to low ,please get minimum score to go next lesson");
    }
}

window.onloadstart = results;
window.onloadstart = closeScore;
window.onloadeddata = nextPage;